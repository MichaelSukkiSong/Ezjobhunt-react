            ...
            <div className="flex flex-col mt-2 px-4 space-y-2 text-sm">
              ...
              <div className="flex flex-col space-y-1">
                ...
                <span className="font-light">
                  ...
                  companies with a history spanning decades. Our mission is to
                  provide our customers with efficient and reliable metal
                  recycling services while minimizing the environmental impact
                  of our ...
                </span>
              </div>
              <div className="flex flex-col space-y-1">
